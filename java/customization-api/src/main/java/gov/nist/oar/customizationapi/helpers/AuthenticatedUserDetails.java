...
/**
 * AuthenticatedUserDetails class presents details of the user authenticated by syste,
 * In this case, it represents short system userId, User's name, User's last name, User's emailid
