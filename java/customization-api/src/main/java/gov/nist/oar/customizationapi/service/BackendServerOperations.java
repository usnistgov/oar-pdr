...
public class BackendServerOperations {
	...
	public BackendServerOperations(RestTemplate restTemplate) {
...
//  Not used  
	/***
	 * // * Check if service is authorized to make changes in backend metadata
	 * server // * // * @param recordid String ediid/unique record id // * @return
