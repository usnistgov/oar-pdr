...
//	    // res.getWriter().write("{\"message\": \"User token is empty or expired.\" }");
//	    res.getWriter().write(mapper.writeValueAsString(new ErrorInfo(HttpStatus.UNAUTHORIZED.value(), "Unauthorizeduser: User token is empty or expired.")));
////	    res.sendError(HttpStatus.UNAUTHORIZED.value(), "User token is empty or expired.");
//	    return;
////	    throw new UnAuthorizedUserException("User token is empty or expired.");
//	}
//	try {
...
////	    res.getWriter().write(new ErrorInfo(HttpStatus.UNAUTHORIZED.value(), "User token is not authorized.").toString());
//	    res.sendError(HttpStatus.UNAUTHORIZED.value(),"User token is not authorized.");
//	}
//
//    }
//
