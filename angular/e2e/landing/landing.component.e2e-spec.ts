...
describe('Landing Page', function() {
  beforeEach(function() {
    ...
    //     httpBackend.whenGET(
    //       'http://testdata.nist.gov/rmm/records/3A1EE2F169DD3B8CE0531A570681DB5D1491')
    //       .respond(
  ...
  it('should display top title of Landing page', async() => {
    ...
    var label = await element(by.css('app-landing .recordType b'));
   ...
   it('should display title of landing page', function() {
    ...
    //var EC = protractor.ExpectedConditions;
    var label = element.all(by.css('app-landing h2'));
